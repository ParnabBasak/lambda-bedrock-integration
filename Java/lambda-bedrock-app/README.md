...
**Runtime Supported = java17**

**Model Supported = Anthropic Claude v2**

It includes the following files and folders.
- LambdaBedrockFunction/src/main - Code for the application's Lambda function.
- LambdaBedrockFunction/pom.xml - Dependent package bedrockruntime = 2.20.157 inclusion
- events - Invocation events that you can use to invoke the function.
- LambdaBedrockFunction/src/test - Unit tests for the application code. 
...
The SAM CLI installs dependencies defined in `LambdaBedrockFunction/pom.xml`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
...
Tests are defined in the `LambdaBedrockFunction/src/test` folder in this project.

```bash
lambda-bedrock-app$ cd LambdaBedrockFunction
lambda-bedrock-app$ mvn test
```
...
```bash
sam delete --stack-name lambda-bedrock-app
```
