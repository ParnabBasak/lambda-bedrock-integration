...
You can find your deployed Lambda Fynction ARN in the output values displayed after deployment.
...
```bash
lambda-bedrock-app$ sam build --use-container
```

The SAM CLI installs dependencies defined in `lambda_bedrock/requirements.txt`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
...
```bash
lambda-bedrock-app$ pip install -r tests/requirements.txt --user
# unit test
lambda-bedrock-app$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
lambda-bedrock-app$ AWS_SAM_STACK_NAME="lambda-bedrock-app" python -m pytest tests/integration -v
```
